...
const purposes = [
  {
    value: "FIND_ROOM",
    title: "कोठा खोज्न",
    description: "आफ्नो बजेटअनुसार कोठा खोज्न",
    icon: Search,
  },
  {
    value: "POST_ROOM",
    title: "कोठा पोस्ट गर्न",
    description: "कोठा वा फ्ल्याट listing राख्न",
    icon: Home,
  },
  {
    value: "FIND_JOB",
    title: "जागिर खोज्न",
    description: "आफ्नो लागि job vacancy खोज्न",
    icon: BriefcaseBusiness,
  },
  {
    value: "POST_JOB",
    title: "Vacancy पोस्ट गर्न",
    description: "कम्पनीको vacancy राख्न",
    icon: Megaphone,
  },
] as const;
    ...
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-slate-900">
          Create your RoomKhoj account
        </h2>
        <p className="mt-2 text-sm text-slate-600">
          केही जानकारी दिनुहोस्, हामी तपाईंलाई सही ठाउँबाट सुरु गराउँछौँ।
        </p>
      </div>
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-base font-semibold text-slate-800">
                  तपाईं RoomKhoj केका लागि प्रयोग गर्दै हुनुहुन्छ?
                </FormLabel>
