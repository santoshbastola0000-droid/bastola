...
const ENGLISH_BEGINNER = [
  ...
  { keys: "Numbers", text: "1 2 3 4 5 10 12 30 50 100 500" },
...
const GAME_MODES: GameMode[] = [
  ...
  { id: "location-hunt", name: "Referral Rewards", nepaliName: "रेफरल पुरस्कार", emoji: "🎁", description: "Invite and Earn सम्बन्धित शब्द", words: {
    english: ["invite and earn", "referral link", "referred user", "referral reward", "three hundred rupees commission", "one hundred rupees discount", "verified referral", "share referral code", "referral earnings"],
    nepali: ["निमन्त्रणा गरेर कमाउनुहोस्", "रेफरल लिङ्क", "रेफरलबाट आएको प्रयोगकर्ता", "रेफरल पुरस्कार", "तीन सय रुपैयाँ कमिसन", "एक सय रुपैयाँ छुट", "प्रमाणित रेफरल"] } },
